...
object ShaderSources {
    val BASE_VERTEX = VERT
    val FLUID = BASE_VERTEX + FLUID_FRAG
    val KAWASE = BASE_VERTEX + KAWASE_FRAG
    val COMPOSITE = BASE_VERTEX + COMPOSITE_FRAG
    val FINAL = BASE_VERTEX + FINAL_FRAG
